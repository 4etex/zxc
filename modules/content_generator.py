...
class ContentGenerator:
    def __init__(self, gemini_api_key: str):
        ...
        self.prompts = {
            "telegram": """Создай увлекательный пост для Telegram канала о подарках и ботах в Telegram на основе тренда: "{title}"

ТЕМА КОНТЕНТА: ПОДАРКИ В TELEGRAM - боты, каналы, способы получения бонусов

Требования:
- Длина: 150-300 слов  
- Стиль: информативный, но живой
- ОБЯЗАТЕЛЬНО упомяни подарки в Telegram, бонусы, боты-подарки
- Добавь эмодзи для привлекательности
- Включи призыв к действию про получение подарков
- Сделай контент про конкретные способы получения подарков в Telegram

Тренд: {description}
URL источника: {url}

ВАЖНО: Контент должен быть именно про ПОДАРКИ И БОНУСЫ В TELEGRAM!
Создай только текст поста, без лишних комментариев.""",

            "youtube_shorts": """Создай сценарий для YouTube Shorts видео длительностью 60 секунд о подарках в Telegram на тему: "{title}"

ТЕМА: ПОДАРКИ И БОНУСЫ В TELEGRAM - как получать, какие боты раздают
...
- ОБЯЗАТЕЛЬНО про конкретные способы получения подарков в Telegram
- Добавь визуальные подсказки в скобках [ПОКАЗАТЬ: ...]
- Сделай контент максимально вирусным про подарки

Исходная информация: {description}
URL: {url}

Создай только сценарий про ПОДАРКИ В TELEGRAM, без лишних комментариев.""",

            "tiktok": """Создай текст для TikTok видео о подарках в Telegram на тему: "{title}"

ТЕМА: ПОДАРКИ В TELEGRAM - боты, бонусы, способы получения

Требования:
- Длина: 50-100 слов
- Стиль: молодёжный, трендовый
- Много эмодзи
- ОБЯЗАТЕЛЬНО про подарки в Telegram и боты
- Хештеги в конце: #telegram #подарки #бонусы
- Сделай максимально цепляющим про бесплатные подарки

Информация: {description}
URL: {url}

Создай только текст ПРО ПОДАРКИ В TELEGRAM, без комментариев.""",

            "instagram": """Создай описание для Instagram поста о подарках в Telegram на тему: "{title}"

ТЕМА: ПОДАРКИ В TELEGRAM - боты раздающие бонусы, способы получения

Требования:
- Длина: 100-200 слов
- Стиль: визуально привлекательный
- ОБЯЗАТЕЛЬНО про подарки и бонусы в Telegram
- Включи релевантные хештеги: #telegram #подарки #бонусы
- Добавь эмодзи
...
Создай только описание поста ПРО ПОДАРКИ В TELEGRAM."""
        }
